          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4">
            <Card>
              ...
              <CardContent className="p-3 md:p-6 pt-0">
                <div className="text-lg md:text-2xl font-bold">{stats.totalMembers}</div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2 p-3 md:p-6">
                ...
                <Calendar className="w-3 h-3 md:w-4 md:h-4 text-highlight" />
              </CardHeader>
              <CardContent className="p-3 md:p-6 pt-0">
                <div className="text-lg md:text-2xl font-bold">{stats.activeEvents}</div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="p-3 md:p-6 pt-0">
                <div className="text-lg md:text-2xl font-bold">₦{stats.totalBalance.toLocaleString()}</div>
              </CardContent>
            </Card>
          </div>
        </div>

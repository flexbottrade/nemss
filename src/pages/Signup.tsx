    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-border bg-accent shadow-xl">
        <CardHeader className="space-y-1 p-4 md:p-6">
          ...
          <CardTitle className="text-xl md:text-2xl font-bold text-[#0E3B43]">Join NEMSS09 Set</CardTitle>
          <CardDescription className="text-xs md:text-sm text-[#0E3B43]/80">Create your account to connect with fellow alumni</CardDescription>
        </CardHeader>
